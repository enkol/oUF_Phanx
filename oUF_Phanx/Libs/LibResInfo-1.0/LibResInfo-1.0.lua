...
local GetSpellInfo = C_Spell.GetSpellName or GetSpellInfo
...
local DEBUG_LEVEL = 0 --C_AddOns.GetAddOnMetadata("LibResInfo-1.0", "Version") and 1 or 0
...
local next, pairs, GetNumGroupMembers, GetTime, IsInGroup, IsInRaid, UnitAura, UnitCastingInfo, UnitGUID, UnitHasIncomingResurrection, UnitHealth, UnitIsConnected, UnitIsDead, UnitIsDeadOrGhost, UnitIsGhost, UnitName
    = next, pairs, GetNumGroupMembers, GetTime, IsInGroup, IsInRaid, UnitAura or C_UnitAuras.GetAuraDataByIndex, UnitCastingInfo, UnitGUID, UnitHasIncomingResurrection, UnitHealth, UnitIsConnected, UnitIsDead, UnitIsDeadOrGhost, UnitIsGhost, UnitName
...
local function UnitAuraByName(unit, searchName, filter)
	...
	if C_UnitAuras.GetAuraDataBySpellName then
		local applications, auraInstanceID, canApplyAura, charges, dispelName, duration, expirationTime, icon, isBossAura, isFromPlayerOrPlayerPet, isHarmful, isHelpful, isNameplateOnly, isRaid, isStealable, maxCharges, name, nameplateShowAll, nameplateShowPersonal, points, sourceUnit, spellId, timeMod = C_UnitAuras.GetAuraDataBySpellName(unit, searchName, filter)
...
-- if C_AddOns.GetAddOnMetadata("LibResInfo-1.0", "Version") then
