...
local function Spawn(self, unit, isSingle)
	...
	if unit == "player" then
		...
		debuffs:SetPoint("BOTTOMLEFT", self, "TOPLEFT", 0, 16)
		...
		buffs:SetPoint("BOTTOMRIGHT", self, "TOPRIGHT", 0, 16)
...
function ns.Factory(oUF)
	...
	-- 	--bar.text:SetFont(FONT_FILE, 16, config.fontOutline or "") -- dragonflight
